                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                        @if($submenu->order != 1)
                                            @csrf()
                                            {!! \Collective\Html\FormFacade::open(['action' => ['SubmenuController@up', $submenu->order], 'method' => 'POST']) !!}
                                    ...
                                    <div class="col-md-1">
                                        @if($submenu->order != count($menu->submenus))
                                            @csrf()
                                            {!! \Collective\Html\FormFacade::open(['action' => ['SubmenuController@down', $submenu->order], 'method' => 'POST']) !!}
                                            {{\Collective\Html\FormFacade::submit('&#8595;', ['class' => 'btn btn-custom'])}}
                                            {!! \Collective\Html\FormFacade::close() !!}
                                        @endif
                                    </div>
